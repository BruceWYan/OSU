...
INSERT INTO Customers(first_name, last_name, user_id, email, street_1, street_2, city, state, zipcode, phone)
VALUES
...
VALUES
(1, 1, 2, '2024-12-01', 37.25, 2.98, 'delivered'),
(2, 2, 1, '2023-12-30', 75, 6, 'delivered'),
(3, 3, 3, '2024-12-04', 37.50, 3, 'picked up')
;
...
INSERT INTO Couriers(first_name, last_name, email, street_1, street_2, city, state, zipcode, phone)
VALUES
...
INSERT INTO Restaurants(name, street_1, street_2, city, state, zipcode, phone, cuisine)
VALUES
