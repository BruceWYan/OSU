...
/***
**Function Name: dynarray_resize
**Description: accepts a new array of pointers and a new capacity and resizes the dynarray
**Parameters: struct dynarray* da, void** new_data, int new_capacity
**Precondition: all variables being inputed must exist
**Postcondition: resize dynarray, run time O(1)
***/
void dynarray_resize(struct dynarray* da, void** new_data, int new_capacity) {
  /*
...
/***
**Function Name: dynarray_capacity
**Description: Gets the capacity of a given Dynarray
**Parameters: struct dynarray* da
**Precondition: the dynarray must exist
