...
** Pre-Conditions: list has to exist
** Post-Conditions: returns the int
**/
...
** Description: returns 1 if the list is empty, returns 0 if the list is not empty
** Parameters: struct list* list
** Pre-Conditions: takes in a list pointer
** Post-Conditions: returns a value to determine if list is empty
**/
...
/** Function: get_head_val
** Description: gets the value of whre the head node is pointing to
** Parameters: struct list* list
** Pre-Conditions: list must not be empty
** Post-Conditions: returns a void pointer
**/
...
** Description: a function pointer returns a 1 if values are the same and 0 if they are not
** Parameters: takes in two void pointers
** Pre-Conditions: void pointers must not be null
