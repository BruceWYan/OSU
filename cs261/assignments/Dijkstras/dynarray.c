...
/** Function: dynarray_swap
** Description: swaps 
** Parameters: struct dynarray* da, int index1, int index2
** Pre-Conditions: index must be whithin range 
** Post-Conditions: swaps elements in an array
**/
void dynarray_swap(struct dynarray* da, int index1, int index2){
  void* temp = da->data[index1];
  da->data[index1] = da->data[index2];
  da->data[index2] = temp;
}
